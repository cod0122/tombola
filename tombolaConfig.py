...
class Config:
    ...
    def __setDimFont(self):
        ...
        if _risCoeff < 0.5:     # es. 800x600 (0,47)
            ...
            if _risCoeff < 1.0:     # es. 1024x768 (0, 77)
                self.__dimFont["fontNumero"]=30
                self.__dimFont["fontNumeroUscito"]=200
                ...
                if _risCoeff < 1.5: # es 1440x900
                    self.__dimFont["fontNumero"]=46
                    ...
                    if _risCoeff < 2.0:     # es 1920x1080 (1,92)
                        self.__dimFont["fontNumero"]=52
    ...
    def risoluzVideo(self, a_risoluzVideo=[0, 0]):
        ...
        self.__setDimFont()
        ilog.stampa('risoluzVideo Coeff: ',  self.__risCoeffX,  self.__risCoeffY)
